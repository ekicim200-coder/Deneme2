...
const GameData = {
  ...
  CLASSES: {
    savasci: {
      ...
      desc: 'Yüksek HP ve savunma. Yakınlaşırsa maç biter.',
      base: { maxHp: 620, attack: 46, magic: 12, defense: 40, attackSpeed: 1.00,
              moveSpeed: 4.2, critChance: 0.05, critDamage: 1.5, penetration: 0.05, range: 1.5 },
      growth: { maxHp: 52, attack: 4.6, magic: 1.0, defense: 3.6 },
      damageStat: 'attack',
  ...
  SKILLS: {
    gucluVurus: {
      ...
      mult: 2.35, cd: 4.5, mana: 18, radius: 2.4, arc: 1.5,
    ...
    donerSaldiri: {
      ...
      mult: 1.55, cd: 8, mana: 26, radius: 3.2, hits: 3, tick: 0.35, self: true,
    ...
    cokluOk: {
      ...
      mult: 0.85, cd: 5, mana: 18, count: 5, spread: 0.55, speed: 15, life: 0.8,
    ...
    deliciOk: {
      ...
      mult: 2.1, cd: 7, mana: 22, count: 1, speed: 22, life: 1.1, pierce: 5, bonusPen: 0.35,
      desc: 'Düşmanları delip geçer, savunmayı yok sayar.'
    },
    kritikOk: {
      name: { su: 'Kristal Ok', ates: 'Patlayıcı Ok' }, type: 'projectile',
      mult: 2.0, cd: 9, mana: 24, count: 1, speed: 18, life: 1.2, forceCrit: true, splash: 2.2,
    ...
    okYagmuru: {
      ...
      mult: 0.95, cd: 16, mana: 38, radius: 3.6, hits: 5, tick: 0.4, castRange: 8,
